...
from lib.classes import DifferentialModulePositions, RobotState, PoseSensorResult, PoseSensorResultType, Value
...
class Localization():
  def __init__(
      ...
      getDriveModulePositions: Callable[[], DifferentialModulePositions],
